...
OTHER_PATTERNS = {
    ...
    "BRCM": {
        ...
        "FDB_EVENT_OTHER_MAC_EXPIRY|Start": re.compile(r".* INFO syncd#syncd.*SAI_API_FDB.*fdbEvent: delete \(0\) for mac (?!00-06-07-08-09-0A).*"),
        "FDB_EVENT_SCAPY_MAC_EXPIRY|Start": re.compile(r".* INFO syncd#syncd.*SAI_API_FDB.*fdbEvent: delete \(0\) for mac 00-06-07-08-09-0A.*")
    },
    "MLNX": {
